...
public:
    ...
    */
    ...
    Q_INVOKABLE void setImageCustomisation(const QByteArray &config, const QByteArray &cmdline, const QByteArray &firstrun, const QByteArray &cloudinit, const QByteArray &cloudinitNetwork, const ImageOptions::AdvancedOptions opts = {}, const QByteArray &initFormat = {}, const QByteArray &systemdFirstrunPath = {});  // Advanced: bypass generator with pre-made scripts
...
protected:
    ...
    QByteArray _expectedHash, _cmdline, _config, _firstrun, _cloudinit, _cloudinitNetwork, _initFormat, _systemdFirstrunPath;
