...
ApplicationWindow {
    ...
    title: {
        var baseTitle = qsTr("M5 Imager %1").arg(imageWriter.constantVersion())
        if (isOffline) {
    ...
    BaseDialog {
        ...
        Text {
            id: quitMessage
            text: qsTr("M5 Imager is still busy. Are you sure you want to quit?")
            font.pointSize: Style.fontSizeDescription
            font.family: Style.fontFamily
            color: Style.textDescriptionColor
            wrapMode: Text.WordWrap
        ...
        RowLayout {
            ...
            ImButton {
                ...
                accessibleDescription: qsTr("Return to M5 Imager and continue the current operation")
                activeFocusOnTab: true
            ...
            ImButtonRed {
                ...
                accessibleDescription: qsTr("Force quit M5 Imager and cancel the current write operation")
                activeFocusOnTab: true
                onClicked: {
    ...
    BaseDialog {
        ...
        RowLayout {
            ...
            ImButton {
                ...
                accessibleDescription: qsTr("Install system authorization to allow M5 Imager to run with elevated privileges")
                activeFocusOnTab: true
            ...
            ImButtonRed {
                id: exitButton
                text: qsTr("Exit")
                accessibleDescription: qsTr("Exit M5 Imager - you must restart with elevated privileges to write images")
                activeFocusOnTab: true
                onClicked: Qt.quit()
            }
        }
