...
static bool installPolkitPolicyForPath(const char* appImagePath) {
    ...
    QString policyContent = QString(
        ...
        "<policyconfig>\n"
        "  <vendor>M5Stack</vendor>\n"
        "  <vendor_url>https://m5stack.com/</vendor_url>\n"
        "  <action id=\"%1\">\n"
        "    <description>Run M5 Imager</description>\n"
        "    <message>Authentication is required to run M5 Imager</message>\n"
